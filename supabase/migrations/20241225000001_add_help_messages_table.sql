...
CREATE INDEX idx_help_messages_help_request_id ON help_messages(help_request_id);
CREATE INDEX idx_help_messages_created_at ON help_messages(created_at DESC);
CREATE INDEX idx_help_messages_sender_type ON help_messages(sender_type);
CREATE INDEX idx_help_messages_is_read ON help_messages(is_read);
