          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                ...
                squares will be highlighted with a checkmark.
              </p>
              
              {/* Mobile-specific instructions */}
              <div className="block sm:hidden bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-xs text-blue-800">
                    ...
                    <p>Pinch to zoom for easier square selection on smaller grids. Selected squares show a blue checkmark.</p>
                  </div>
                </div>
              </div>
